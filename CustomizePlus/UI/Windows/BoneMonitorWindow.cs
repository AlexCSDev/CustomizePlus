...
internal class BoneMonitorWindow : WindowBase
{
    ...
    private          bool                                  aggregateDeforms;

    private BoneAttribute targetAttribute;


    private CharacterProfile? targetProfile;

    protected override string Title
        => $"Bone Monitor: {targetProfile.ToDebugString()}";

    protected override string DrawTitle
        => $"{Title}###bone_monitor_window{Index}";

    protected override ImGuiWindowFlags WindowFlags
        => ImGuiWindowFlags.NoScrollbar | ImGuiWindowFlags.NoScrollWithMouse;

    private Armature? TargetSkeleton
        => targetProfile.Armature;
