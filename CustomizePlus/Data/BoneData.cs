...
public static class BoneData
{
    ...
    private static readonly string[] BoneRawTable =
    {
        ...
        "n_root,Root,Root,TRUE,FALSE,,",
        "n_hara,Abdomen,Root,TRUE,FALSE,,",
        "j_kao,Head,Spine,TRUE,FALSE,j_kubi,",
        "j_kubi,Neck,Spine,TRUE,FALSE,j_sebo_c,",
        "j_sebo_c,Spine C,Spine,TRUE,FALSE,j_sebo_b,",
        "j_sebo_b,Spine B,Spine,TRUE,FALSE,j_sebo_a,",
        "j_sebo_a,Spine A,Spine,TRUE,FALSE,j_kosi,",
        "j_kosi,Waist,Spine,TRUE,FALSE,,",
        "j_kami_a,Hair A,Hair,TRUE,FALSE,j_kao,",
        "j_kami_b,Hair B,Hair,TRUE,FALSE,j_kami_a,",
        "j_kami_f_l,Hair Front Left,Hair,TRUE,FALSE,j_kao,j_kami_f_r",
        ...
        "j_f_memoto,Bridge,Face,TRUE,FALSE,j_kao,",
        "j_f_umab_l,Eyelid Upper Left,Face,TRUE,FALSE,j_kao,j_f_umab_r",
        ...
        "j_f_eye_l,Eye Left,Face,TRUE,FALSE,j_kao,j_f_eye_r",
        "j_f_eye_r,Eye Right,Face,TRUE,FALSE,j_kao,j_f_eye_l",
        ...
        "j_f_lip_r,Lips Right,Face,TRUE,FALSE,j_kao,j_f_lip_l",
        "j_f_ulip_a,Lip Upper A,Face,TRUE,FALSE,j_kao,",
        "j_f_ulip_b,Lip Upper B,Face,TRUE,FALSE,j_kao,",
        "j_f_dlip_a,Lip Lower A,Face,TRUE,FALSE,j_kao,",
        ...
        "j_f_dlip,Hrothgar Lip Lower,Face,FALSE,FALSE,j_kao,",
        "j_ago,Jaw,Face,TRUE,FALSE,j_kao,",
        "j_f_uago,Hrothgar Palate Upper,Face,FALSE,FALSE,j_kao,",
        "j_f_ulip,Hrothgar Palate Lower,Face,FALSE,FALSE,j_kao,",
        "j_mimi_l,Ear Left,Ears,TRUE,FALSE,j_kao,j_mimi_r",
        "j_mimi_r,Ear Right,Ears,TRUE,FALSE,j_kao,j_mimi_l",
        ...
        "n_hte_r,Wrist Right,Arms,TRUE,FALSE,j_ude_b_r,n_hte_l",
        "j_te_l,Hand Left,Hands,TRUE,FALSE,n_hte_l,j_te_r",
        ...
        "iv_ko_c_r,Pinky C Right,Hands,FALSE,TRUE,j_ko_b_r,iv_ko_c_l",
        "n_sippo_a,Tail A,Tail,FALSE,FALSE,j_kosi,",
        "n_sippo_b,Tail B,Tail,FALSE,FALSE,n_sippo_a,",
        "n_sippo_c,Tail C,Tail,FALSE,FALSE,n_sippo_b,",
        "n_sippo_d,Tail D,Tail,FALSE,FALSE,n_sippo_c,",
        "n_sippo_e,Tail E,Tail,FALSE,FALSE,n_sippo_d,",
        ...
        "iv_ochinko_a,Penis A,Groin,FALSE,TRUE,j_kosi,",
        "iv_ochinko_b,Penis B,Groin,FALSE,TRUE,iv_ochinko_a,",
        ...
        "iv_ochinko_f,Penis F,Groin,FALSE,TRUE,iv_ochinko_e,",
        "iv_omanko,Vagina,Groin,FALSE,TRUE,j_kosi,",
        "iv_kuritto,Clitoris,Groin,FALSE,TRUE,iv_omanko,",
        "iv_inshin_l,Labia Left,Groin,FALSE,TRUE,iv_omanko,iv_inshin_r",
        "iv_inshin_r,Labia Right,Groin,FALSE,TRUE,iv_omanko,iv_inshin_l",
        "iv_koumon,Anus,Groin,FALSE,TRUE,j_kosi,",
        ...
        "j_ex_met_va,Visor,Hat,FALSE,FALSE,j_kao,",
        "j_ex_met_a,Hat Accessory A,Hat,FALSE,FALSE,j_kao,",
    ...
    public static string? GetBoneDisplayName(string codename)
        => BoneTable.TryGetValue(codename, out var row) ? row.DisplayName : null;

    public static string? GetBoneCodename(string boneDisplayName)
        => BoneLookupByDispName.TryGetValue(boneDisplayName, out var name) ? name : null;

    public static List<string> GetBoneCodenames()
        => BoneTable.Keys.ToList();
    ...
    public static List<string> GetBoneDisplayNames()
        => BoneLookupByDispName.Keys.ToList();

    public static BoneFamily GetBoneFamily(string codename)
        => BoneTable.TryGetValue(codename, out var row) ? row.Family : BoneFamily.Unknown;

    public static bool IsDefaultBone(string codename)
        => BoneTable.TryGetValue(codename, out var row) && row.IsDefault;

    public static int GetBoneIndex(string codename)
        => BoneTable.TryGetValue(codename, out var row) ? row.RowIndex : 0;

    public static bool IsIVCSBone(string codename)
        => BoneTable.TryGetValue(codename, out var row) && row.IsIVCS;

    public static string? GetBoneMirror(string codename)
        => BoneTable.TryGetValue(codename, out var row) ? row.MirroredCodename : null;

    public static string[] GetChildren(string codename)
        => BoneTable.TryGetValue(codename, out var row) ? row.Children : Array.Empty<string>();

    public static bool IsProbablyHairstyle(string codename)
        => Regex.IsMatch(codename, @"j_ex_h\d\d\d\d_ke_[abcdeflrsu](_[abcdeflrsu])?");

    public static bool IsNewBone(string codename)
        => !BoneTable.ContainsKey(codename);
