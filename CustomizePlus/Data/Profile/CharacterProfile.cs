...
public sealed class CharacterProfile
{
    ...
    /// </summary>
    public CharacterProfile(CharacterProfile original)
        : this()
    {
    ...
    public override string ToString()
        => $"Profile '{ProfileName}' on {CharacterName}";

    public string ToDebugString()
        => $"Profile ({_localId}) '{ProfileName}' on {CharacterName}";

    public override bool Equals(object? obj)
        => obj is CharacterProfile other
